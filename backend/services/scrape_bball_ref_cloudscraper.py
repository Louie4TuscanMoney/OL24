"""
BASKETBALL REFERENCE SCRAPER - Using CloudScraper + Pandas
Fixes SSL certificate issues and handles BR's complex HTML structure
"""
...
class BballRefCloudScraper:
    """Use cloudscraper + pandas to scrape Basketball Reference"""
    ...
    def __init__(self):
        ...
        print("="*80)
        print("🏀 BASKETBALL REFERENCE SCRAPER (CloudScraper + Pandas)")
        print("="*80)
